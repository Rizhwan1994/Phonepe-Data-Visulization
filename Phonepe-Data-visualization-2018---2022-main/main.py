...
df = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/Agg_Trans.csv', index_col=0)
state = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/Longitude_Latitude_State_Table.csv')
districts = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/Data_Map_Districts_Longitude_Latitude.csv')
districts_tran = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/district_map_transaction.csv', index_col=0)
app_opening = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/district_registering_map.csv', index_col=0)
user_device = pd.read_csv('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/csv/user_by_device.csv', index_col=0)
...
with st.container():
    ...
    image = Image.open('C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/data/Data-Vizualisation.png')
    st.image(image, caption='C:/Users/Puspa/Desktop/Phonepe-Data-visualization-2018---2022-main/data/Data-Vizualisation.png')
    st.write(' ')
    st.subheader(
